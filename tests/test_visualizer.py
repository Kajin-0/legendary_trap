...
from legendary_trap.visualizer import HEIGHT, PRESETS, WIDTH, render_frame
...
def test_presets_have_required_visual_dimensions_and_are_deterministic() -> None:
    ...
    for name in ("orbital", "horizon", "atmospheric"):
...
def test_preset_names_are_explicit() -> None:
    assert set(PRESETS) == {"orbital", "horizon", "atmospheric"}
